    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8 max-w-4xl">
        <div className="bg-white shadow rounded-lg p-6 md:p-8">
          <Link 
            to="/" 
            className="mb-8 inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-800"
          >
            &larr; Back to Home
          </Link>
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Last Updated: 12 May 2025</p>
          </div>
          ...
          <div className="prose max-w-none">
            ...
            <p className="mb-6">
              If you have any questions or concerns, please contact us at <a href="mailto:info@aerestechnologies.co.ke" className="text-blue-600 hover:underline">info@aerestechnologies.co.ke</a>.
            </p>

            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-3">1. Scope of This Policy</h2>
            ...
            <div className="mb-6">
              ...
              <p className="font-medium">a) Personal Information (Voluntarily Provided)</p>
              ...
              <p className="font-medium">b) Device and App Usage Information (Automatically Collected)</p>
              <ul className="list-disc pl-5 mb-3">
              ...
              <p className="font-medium">c) Call Metadata (Non-sensitive)</p>
              ...
              <p className="italic">Note: We do not access, record, store, or transmit the actual content of any phone calls or contacts.</p>
              
              <p className="font-medium">d) Location Data</p>
              <ul className="list-disc pl-5 mb-3">
            ...
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-3">4. Legal Basis for Data Processing</h2>
            ...
            <div className="mb-6">
              ...
              <p>These third parties are obligated to handle your data securely and in compliance with data protection standards.</p>
            ...
            <div className="mb-6">
              ...
              <p>Data that is no longer needed is securely deleted or anonymized.</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p>To exercise these rights, email us at <a href="mailto:info@aerestechnologies.co.ke" className="text-blue-600 hover:underline">info@aerestechnologies.co.ke</a>.</p>
            </div>
            ...
            <div className="mb-6">
              ...
              <p>However, no system is completely immune to security threats, and we urge users to protect their devices.</p>
            </div>
            ...
            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-3">10. Policy Updates</h2>
              ...
              <p>The latest version of this policy will always be available within the App or on our website.</p>
            </div>

            <div className="mb-6">
              <h2 className="text-xl font-semibold text-gray-900 mb-3">11. Contact Us</h2>
              <p>For questions, concerns, or data requests, please contact:</p>
              <p className="font-medium">Aeres Technologies Limited</p>
              <p>📧 <a href="mailto:info@aerestechnologies.co.ke" className="text-blue-600 hover:underline">info@aerestechnologies.co.ke</a></p>
              <p>📍 Nairobi, Kenya</p>
            </div>
          </div>
        </div>
